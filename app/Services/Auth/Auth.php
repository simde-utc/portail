...
abstract class Auth
{
    ...
    protected static function findUser($key, $value) {
        $model = self::model;

        return $model::where($key, $value)->first();
    }

    protected static function create($email, $lastname, $firstname, $infos = []) {
    ...
    protected static function update($lastname, $firstname, $infos = []) {
